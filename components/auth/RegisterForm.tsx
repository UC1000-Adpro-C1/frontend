...
const UserRegisterForm: React.FC<UserRegisterFormProps> = ({ onSubmit }) => {
  const [formData, setFormData] = useState<UserRegisterData>({ username: '', password: '' , email:'', role:'' });
            ...
            <div className="mb-4">
              ...
              <div className="mt-1 flex items-center">
                <input
                  ...
                  required
                />
                <label htmlFor="role-user" className="ml-3 block text-sm font-medium text-gray-700">USER</label>
              </div>
              <div className="mt-1 flex items-center">
                <input
                  id="role-staff"
                  ...
                  required
                />
                <label htmlFor="role-staff" className="ml-3 block text-sm font-medium text-gray-700">STAFF</label>
              </div>
            </div>
